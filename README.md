...
- [Contributing to the XinFin content repository](#contributing-to-the-xinfin-content-repository)
	- [Creating and changing articles](#creating-and-changing-articles)
		- [Create an article](#create-an-article) and [Current Content Requirement](https://github.com/XinFinOrg/Community-Articles/tree/master/Content%20Contribution%20Requirement)
...
See [brief video overview](https://www.youtube.com/channel/UCQaL6FixEQ80RJC0B2egX6g) (Coming Soon..) of how to add/edit content on the XinFin network.
